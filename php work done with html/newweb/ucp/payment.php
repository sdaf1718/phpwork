...
if(isset($_POST["buy"]))
{
	// getting what the user has input via a button via variables 
session_start();
...
// query to insert intot he payment table what the user has inputed
...
// if successful no errors then insert into database otherwise display error
