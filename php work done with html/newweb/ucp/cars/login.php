...
<img src="carlogo.png" alt="carlogo" style="width:100px;height:100px;"align="left" >
  ...
  <h1>Taz's secure payment verfication system</h1>
</div>
<div id ="nav">
...
<br>
<p>
you will need to login in order for confrimation of your order if you have not registered then please register
</p>
<?php
...
$email='email';
    ...
    if ($email && $password )
    {
        ...
        $query = "SELECT * FROM customers WHERE email = '$email' AND password = '$password'";// AND password = $password";
...
// checks if you logged in if not then display the login form 
  ...
  <table width='354; height='61' border='3'>
    <tr>
      <td width='146'><a href='register.php'>Notregistered</a></td>
