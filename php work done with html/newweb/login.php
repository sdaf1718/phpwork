...
if (isset($_SESSION['username'])) {
    ...
    $sql = "SELECT email, password FROM customers WHERE email = ? AND password = password(?)";
...
<form action="login.php" method="post" style="margin-top:200px; margin-left:300px;">

					<input type="text" name="email" placeholder="Username"><br><br><br>
